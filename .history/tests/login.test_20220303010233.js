...
describe("Test logging into Hudl", () => {
  ...
  test("Test all buttons on login page to check they all work", async () => {
    ...
    await checkElementVisibility(driver, "div.form__label--custom");

    // Check log in with organization button is visible
    await checkElementVisibility(driver, "#logInWithOrganization");

    // Check sign up is visible
    await checkElementVisibility(driver, "div.sign-up-trial a");
